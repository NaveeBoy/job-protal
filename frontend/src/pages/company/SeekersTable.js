...
const SeekersTable = () => {
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      await axios.put(
        `http://localhost:9000/api/user/jobhistory/${jobHistoryId}`,
        { applicationStatus: status }
      );
      await axios.post("http://localhost:9000/api/send-email", {
        userEmail,
        status,
      });
  ...
  const filterSeekers = () => {
    ...
    return seekers
      .map((seeker) => ({
        ...seeker,
        jobsHistory: seeker.jobsHistory.filter(
          (jobHistory) =>
  ...
  return (
    <>
      ...
      <Typography
        variant="h4"
        sx={{ color: "white", pb: 3, textAlign: "center" }}
      >
        ...
        >
          <Table>
            <TableHead>
              <TableRow
                sx={{
                  backgroundColor: "secondary.midNightBlue",
                  position: "sticky",
                  top: 0,
                }}
              >
                <TableCell
                  align="center"
                  sx={{ color: "primary.contrastText", width: 200 }}
                >
                  First Name
                </TableCell>
                <TableCell
                ...
                <TableCell
                  align="center"
                  sx={{ color: "primary.contrastText", width: 400 }}
                >
                  Job Apply Details
                </TableCell>
              </TableRow>
            ...
            >
              {filteredSeekers.map((seeker) => (
                <TableRow
                  ...
                  sx={{
                    backgroundColor: "#0277bd",
                    "&:hover": { backgroundColor: "secondary.midNightBlue" },
                  }}
                >
                  <TableCell
                    align="center"
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to {currentJobAction.status.toLowerCase()}{" "}
